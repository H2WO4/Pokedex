...
public class TestPokemonClass
{
    ...
    public void PokemonStats()
    {
        ...
        arceus.SetIVs(0, 0, 0, 0,
                      0, 0);
        arceus.SetEVs(0, 0, 0, 0,
                      0, 0);
    ...
    public void PokemonEVsExceptions()
    {
        ...
        // * Multi-EV assignment
        Assert.ThrowsException<ArgumentException>(() => arceus.SetEVs(100, 100, 100, 100,
                                                                      100, 11),
                                                  "EVs whose total surpass 510 were accepted, whereas it should not");
        Assert.ThrowsException<ArgumentException>(() => arceus.SetEVs(253, 0, 0, 0,
                                                                      0, 0),
                                                  "EV above 252 was accepted, whereas it should not");
        Assert.ThrowsException<ArgumentException>(() => arceus.SetEVs(-1, 0, 0, 0,
                                                                      0, 0),
                                                  "Negative EV was accepted, whereas it should not");
    }
