...
namespace Pokedex.Models.Pokemons
{
	...
	{
		# region Constructor
		public Arceus(int level) : base(ArceusSpecies.Singleton, level) {}
		public Arceus(int level, string nickname) : base(ArceusSpecies.Singleton, level, nickname) {}
		public Arceus(int level, string nickname, Dictionary<string, int> evs) : base(ArceusSpecies.Singleton, level, nickname, evs) {}
		# endregion
	}
}